...
public class BookReviewGridAdapter extends BaseAdapter {
...
//    }
    ...
    //コンストラクタ
    public BookReviewGridAdapter(Context context, int itemLayoutId, List<String> word) {
        sContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            // ViewHolder を生成
            holder = new BookReviewGridAdapter.ViewHolder();
            holder.bookReviewText = convertView.findViewById(R.id.item_book_review_text);
            convertView.setTag(holder);
        } else {
            holder = (BookReviewGridAdapter.ViewHolder) convertView.getTag();
        }
